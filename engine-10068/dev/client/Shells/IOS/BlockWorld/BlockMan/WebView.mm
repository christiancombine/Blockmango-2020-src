...
- (id)initWithGameObjectName:(const char *)gameObjectName_
{
    ...
    BaseRootViewController* rootViewController = (BaseRootViewController*)((AppDelegate*)[UIApplication sharedApplication].delegate).viewController;
    ...
    [button setFrame:CGRectMake(view.frame.size.width-120, 5, 120, 30)];
    [button setTitle:@"<<<返回游戏" forState:UIControlStateNormal];
