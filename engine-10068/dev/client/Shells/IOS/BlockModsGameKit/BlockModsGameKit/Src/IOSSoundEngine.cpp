...
namespace LORD
{
	...
	{
		SimpleAudioEngine::sharedEngine()->playBackgroundMusic(strFilePath.c_str(), false, 0, 0);
	}
    
	void IOSSoundEngine::playBackgroundMusic( String strFilePath, bool bLoop, float fMinInterval, float fMaxinterval)
	{
		SimpleAudioEngine::sharedEngine()->playBackgroundMusic(strFilePath.c_str(), bLoop, fMinInterval, fMaxinterval);
	}
	...
	unsigned int IOSSoundEngine::playEffect( String strFilePath, bool bLoop, float fMinInterval, float fMaxInterval)
	{
		return SimpleAudioEngine::sharedEngine()->playEffect(strFilePath.c_str(), bLoop, fMinInterval, fMaxInterval);
	}
