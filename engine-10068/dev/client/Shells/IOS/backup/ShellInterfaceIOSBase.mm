...
namespace GameClient {
    ...
    ShellInterfaceIOSBase::ShellInterfaceIOSBase()
    {
    ...
    void ShellInterfaceIOSBase::login()
    {
    }
    
    void ShellInterfaceIOSBase::logout()
    {
    }
    
    void ShellInterfaceIOSBase::enterUserCenter()
    {
    }
    
    void ShellInterfaceIOSBase::enterAppBBS()
    {
    }
 
    void ShellInterfaceIOSBase::payWithInfo(const LORD::GUIString& payInfo)
    {
    ...
    void ShellInterfaceIOSBase::onUpdatePushInfo(const LORD::GUIString& pushInfo)
    {
        // 取消所有的本地推送
    ...
    void ShellInterfaceIOSBase::onClearPushInfo()
    {
        // 取消所有的本地推送
        [[UIApplication sharedApplication] cancelAllLocalNotifications];
        [UIApplication sharedApplication].applicationIconBadgeNumber = 0;
    ...
    LORD::GUIString ShellInterfaceIOSBase::getDeviceInfo()
    {
        NSString* deviceType = [UIDevice currentDevice].model;
        
        LORD::GUIString deviceInfo = LORD::GUIString([deviceType UTF8String]);
