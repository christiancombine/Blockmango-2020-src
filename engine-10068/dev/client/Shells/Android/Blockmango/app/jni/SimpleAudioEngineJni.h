...
extern "C"
{
    ...
    extern void playBackgroundMusicJNI(const char *path, bool isLoop, float fMinInterval, float fMaxInterval);
    ...
    extern unsigned int playEffectJNI(const char* path, bool bLoop, float fMinInterval, float fMaxInterval);
