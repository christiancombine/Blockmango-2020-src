...
public class EchoesEditBoxDialog extends Dialog
{
	// ===========================================================
	// Constants
	// ===========================================================
...
//		super(context, R.style.Theme_Translucent);
	...
	protected void onCreate(final Bundle pSavedInstanceState)
	{
		...
		final LinearLayout.LayoutParams editTextParams = 
		...
		this.mInputEditText.setImeOptions(EditorInfo.IME_ACTION_DONE);
		...
		initHandler.postDelayed(new Runnable() 
		{
			...
			public void run() 
			{
				EchoesEditBoxDialog.this.mInputEditText.requestFocus();
				EchoesEditBoxDialog.this.mInputEditText.setSelection(EchoesEditBoxDialog.this.mInputEditText.length());
				EchoesEditBoxDialog.this.openKeyboard();
			}
		}, 200);
		...
		this.mInputEditText.setOnEditorActionListener(new OnEditorActionListener()
		{
			...
			public boolean onEditorAction(final TextView v, final int actionId, final KeyEvent event) 
			{
				...
				{
					EchoesHelper.setEditTextDialogResult(EchoesEditBoxDialog.this.mInputEditText.getText().toString());
					EchoesEditBoxDialog.this.closeKeyboard();
					EchoesEditBoxDialog.this.dismiss();
					return true;
				}
				return false;
			}
