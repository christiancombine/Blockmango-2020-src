...
date:		2018-3-6
*********************************************************************/
#ifndef __ENTITY_CHEST_FX_HEADER__
#define __ENTITY_CHEST_FX_HEADER__
...
namespace BLOCKMAN
{
	...
	class EntityChestFX : public EntityFx
	{
	public:
		EntityChestFX(World* pWorld, const Vector3& pos, const Vector3& pos2, float scale = 1.f);
