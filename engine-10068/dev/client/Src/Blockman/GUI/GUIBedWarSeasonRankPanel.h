#ifndef __GUI_BED_WAR_SEASON_RANK_PANEL_HEADER__
#define __GUI_BED_WAR_SEASON_RANK_PANEL_HEADER__
...
namespace BLOCKMAN
{
	class GUIBedWarSeasonRankPanel : public CustomGuiWindow
	{
	private:
	...
	public:
		GUIBedWarSeasonRankPanel(const GUIWindowType& nType, const GUIString& strName);
		~GUIBedWarSeasonRankPanel() = default;
