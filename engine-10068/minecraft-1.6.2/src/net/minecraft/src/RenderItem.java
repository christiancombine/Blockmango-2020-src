...
public class RenderItem extends Render
{
    ...
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5)
    {
        ...
        {
            GL11.glDisable(GL11.GL_LIGHTING);
            ResourceLocation var15 = par2TextureManager.func_130087_a(par3ItemStack.getItemSpriteNumber());
            par2TextureManager.func_110577_a(var15);

            if (var8 == null)
            {
                var8 = ((TextureMap)Minecraft.getMinecraft().func_110434_K().func_110581_b(var15)).func_110572_b("missingno");
            }
