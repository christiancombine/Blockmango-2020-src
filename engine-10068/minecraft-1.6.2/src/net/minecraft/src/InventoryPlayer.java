...
public class InventoryPlayer implements IInventory
{
    ...
    public InventoryPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        /** add by zhouyou. add some itemstacks to player.*/
        int idx = 0;
        mainInventory[idx++] = new ItemStack(Block.torchWood, 64, 0);
        mainInventory[idx++] = new ItemStack(Block.glass, 64, 0);
        mainInventory[idx++] = new ItemStack(Item.bucketWater, 1, 0);
        mainInventory[idx++] = new ItemStack(Item.bucketWater, 1, 0);
        mainInventory[idx++] = new ItemStack(Block.dirt, 64, 0);
        mainInventory[idx++] = new ItemStack(Item.bucketWater, 1, 0);
        mainInventory[idx++] = new ItemStack(Item.bucketLava, 1, 0);
        mainInventory[idx++] = new ItemStack(Item.bucketLava, 1, 0);
    }
