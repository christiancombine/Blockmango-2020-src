    ...
    protected void genAchievementBackground(int par1, int par2, float par3)
    {
        ...
        for (var22 = 0; var22 < AchievementList.achievementList.size(); ++var22)
        {
            ...
            if (var37 >= -24 && var25 >= -24 && var37 <= 224 && var25 <= 155)
            {
                ...
                var32.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.func_110434_K(), var33.theItemStack, var38 + 3, var39 + 3);
                GL11.glDisable(GL11.GL_LIGHTING);
        ...
        if (var30 != null)
        {
            String var34 = I18n.func_135053_a(var30.getName());
            ...
            if (this.statFileWriter.canUnlockAchievement(var30))
            {
                ...
                if (this.statFileWriter.hasAchievementUnlocked(var30))
                {
                    this.fontRenderer.drawStringWithShadow(I18n.func_135053_a("achievement.taken"), var37, var25 + var39 + 4, -7302913);
                }
            }
            else
            {
                var38 = Math.max(this.fontRenderer.getStringWidth(var34), 120);
                String var41 = I18n.func_135052_a("achievement.requires", new Object[] {I18n.func_135053_a(var30.parentAchievement.getName())});
