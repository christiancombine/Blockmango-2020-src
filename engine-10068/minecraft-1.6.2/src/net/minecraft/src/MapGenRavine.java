                            ...
                            for (var44 = var57; var44 < var39; ++var44)
                            {
                                ...
                                if (var59 * var59 + var45 * var45 < 1.0D)
                                {
                                    for (int var49 = var37 - 1; var49 >= var56; --var49)
                                    {
                                        ...
                                        double temp1 = (var59 * var59 + var45 * var45) * (double)this.field_75046_d[var49] + var50 * var50 / 6.0D;
                                        if ( temp1 < 1.0D)
                                        {
    ...
    protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, byte[] par6ArrayOfByte)
    {
        if (this.rand.nextInt(50) == 0)
        {
            ...
            for (int var14 = 0; var14 < var13; ++var14)
            {
                ...
                float r3 = this.rand.nextFloat();
                float var15 = r1 * (float)Math.PI * 2.0F;
                float var16 = (r2 - 0.5F) * 2.0F / 8.0F;
                float var17 = (r3 * 2.0F + this.rand.nextFloat()) * 2.0F;
