...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage
{
    ...
    protected void initialWorldChunkLoad()
    {
        ...
        for (int var11 = -32; var11 <= 32 && this.isServerRunning(); var11 += 16)
        {
            for (int var12 = -32; var12 <= 32 && this.isServerRunning(); var12 += 16)
            {
        ...
        this.outputLoadedChunks();
    }

    // add by zhouyou.
    public void outputLoadedChunks()
    {
        WorldServer worldServer = this.worldServers[0];
        if(worldServer.isDebug())
            worldServer.theChunkProviderServer.saveAllChunks("Java-MC");
    }
