...
#ifndef _GUIBoundSlot_h_
#define _GUIBoundSlot_h_
...
public:
    ...
    */
    BoundSlot(Group group, const SubscriberSlot& subscriber, GUIEvent& event);
...
private:
    ...
    GUIEvent* d_event;                 //! The event to which the slot was attached
};
