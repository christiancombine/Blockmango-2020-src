#ifndef __CPP14_UTILITY_HEADER__
#define __CPP14_UTILITY_HEADER__
#include <type_traits>

namespace CPP14_UTILITY_DETAIL
{
...
namespace std {
	using CPP14_UTILITY_DETAIL::integer_sequence;
	using CPP14_UTILITY_DETAIL::index_sequence;
	using CPP14_UTILITY_DETAIL::make_integer_sequence;
	using CPP14_UTILITY_DETAIL::make_index_sequence;
	using CPP14_UTILITY_DETAIL::index_sequence_for;
}
