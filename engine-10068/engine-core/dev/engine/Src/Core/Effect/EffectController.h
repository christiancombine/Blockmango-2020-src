...
#ifndef __LORD_EFFECT_CONTROLLER_H__
#define __LORD_EFFECT_CONTROLLER_H__
...
namespace LORD
{
	...
	class LORD_CORE_API EffectController : public IElement, public ObjectAlloc
	{
	public:
		//interface
	...
	class LORD_CORE_API EffectTranslation : public EffectController
	{
	...
	class LORD_CORE_API EffectRotationSelf : public EffectController
	{
	...
	class LORD_CORE_API EffectRotationAxis : public EffectController
	{
	...
	// Priority 3
	class LORD_CORE_API EffectRotationRevolution : public EffectController
	{
	...
	// Priority 1
	class LORD_CORE_API EffectOffcenter : public EffectController
	{
	...
	// Priority 6
	class LORD_CORE_API EffectColorChange : public EffectController
	{
	...
	// Priority 9
	class LORD_CORE_API EffectScaleChange : public EffectController
	{
	...
	// Priority 8
	class LORD_CORE_API EffectScaleNoise : public EffectController
	{
	...
	// Priority 5
	class LORD_CORE_API EffectColorNoise : public EffectController
	{
	...
	// Priority 7
	class LORD_CORE_API EffectColorSet : public EffectController
	{
	...
	// Priority 10
	class LORD_CORE_API EffectScaleSet : public EffectController
	{
