...
---
CheckPointRank = class("CheckPointRank", BaseRank)

function CheckPointRank:init()
    self.rankKey = Define.RankKey.CheckPoint .. self.config.param
    self.pageSize = 4
    self.rowNum = 5
    ---每一列 偏移位置 和 列头
...
function CheckPointRank:printData(list, scale, alpha)
    scale = scale or 1
    alpha = alpha or 1
