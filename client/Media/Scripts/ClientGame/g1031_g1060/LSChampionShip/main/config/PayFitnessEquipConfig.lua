...
PayFitnessEquipConfig.settings = MemoryPool.newTable()

function PayFitnessEquipConfig:loadConfig()

    local config = FileUtil.getConfigFromCsv("setting/PayFitnessEquip.csv",2)
